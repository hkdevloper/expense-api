...
class IncomeCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = TransactionCategory::where('created_by', Auth::id())
            ->where('category_type', 'Income')->paginate($request->per_page);
    ...
    public function update(Request $request, int $id)
    {
        ...
        return response()->json(['data' => 'income_category_updated', 'request' => $request->all()]);
    }
    ...
    public function destroy(int $id)
    {
        ...
        if ($incomeCategoryById->delete()) {
            return response()->json(['data' => 'income_category_deleted']);
        } else {
